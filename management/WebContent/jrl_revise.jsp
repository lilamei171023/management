...
<div id="div1">
 <form action="jrl_reviseHandler.jsp" method="get" id="form1">
	<table id="tab" cellspacing="0">
			<tr align="center" id="tabTitle">
                ...
                <td>  <select id="userTitle" onchange=""  name="userTitle">
                ...
                <td>
                <select id="userformerDept" name="userformerDept">
                        <option value="<%=userformerDept%>"><%=userformerDept%> </option>
                ...
                <td> 
                <select id="usernowDept"  name="usernowDept">
                      <option value="<%=usernowDept%>" ><%=usernowDept%></option>
                       <option value="人事部">人事部</option>
                        <option value="财务部">财务部</option>
                        <option value="市场部">市场部</option>
                        <option value="销售部">销售部</option>
                ...
                <td> <input type="text" name=userSalary value="<%=userSalary%>"></td>
                <td>  <select id="Title" name="userTrain" style=" width:90px" >
                        <option value="<%=userTrain%>"><%=userTrain%></option>
                        <option value="是">是</option>
                        <option value="否">否</option>
                  </select></td>
                <td> <input type="text" name=userReward value="<%=userReward%>"></td>
