...
<meta http-equiv="refresh" content="1;http://localhost:8080/management/bf_search.jsp">
<title>Insert title here</title>
<script type="text/javascript" src="js/jquery-3.2.1.min.js"></script>
<style type="text/css">
body{
             background-image:url(images/humb.jpg);
...
<h2 style="color:red">操作成功,正在跳转.....</h2>
<%
String plugin=(String)session.getAttribute("plugin");
